...
export class ReimbursementService {
  ...
  addCase(reimbursementModel: Reimbursement): Observable<Reimbursement> {
    ...
    return this.http.post<Reimbursement>("http://localhost:2020/api/reimbursements/add", formData);
  }
  ...
  downloadImage(imageId: number | undefined): Observable<any> {
    ...
    return this.http.get<Reimbursement[]>("http://localhost:2020/api/reimbursements/download/" + imageId, httpOptions);
  }
